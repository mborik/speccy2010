...
const CParameter iniParameters[] = {
	...
	CParameter(PTYPE_LIST, PGRP_GENERAL, "Joystick emulation", "None|Kempston|Sinclair I|Sinclair II|Cursor|QAOPM", &specConfig.specJoyModeEmulation),
	CParameter(PTYPE_LIST, PGRP_GENERAL, "Joystick 1", "None|Kempston|Sinclair I|Sinclair II|Cursor|QAOPM", &specConfig.specJoyMode1),
	CParameter(PTYPE_LIST, PGRP_GENERAL, "Joystick 2", "None|Kempston|Sinclair I|Sinclair II|Cursor|QAOPM", &specConfig.specJoyMode2),
