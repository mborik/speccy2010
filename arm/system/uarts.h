#ifndef SYSTEM_UARTS_H_INCLUDED
#define SYSTEM_UARTS_H_INCLUDED
...
public:
	...
	inline dword GetRxCntr() { return rx_cntr; }
	inline dword GetTxCntr() { return tx_cntr; }
	inline dword GetTxFreeBuffer() { return tx_size - tx_cntr; }

	byte ReadByte();

	dword ReadFile(byte *s, dword N);
